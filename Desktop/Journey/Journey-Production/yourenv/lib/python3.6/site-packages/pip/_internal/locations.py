...
if running_under_virtualenv():
    src_prefix = os.path.join(sys.prefix, 'Journey-Production')
else:
    # FIXME: keep Journey-Production in cwd for now (it is not a temporary folder)
    try:
        src_prefix = os.path.join(os.getcwd(), 'Journey-Production')
    except OSError:
